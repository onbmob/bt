 ...
 * utilization is higher than you'route like, then you may want to consider reducing FPS.  If the camera
...
public class CameraSource {
    ...
    private class FrameProcessingRunnable implements Runnable {
         ...
         * <p/>
         * If you find that this is using more CPU than you'route like, you should probably decrease the
